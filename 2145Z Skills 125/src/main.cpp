...
void autonomous(void) {
  ...
  allSpin(-100);
  task::sleep(400);
  leftPID(208,4,1,80,.8,.05, 5);
  index(60,100);
  forwardPID(980,-208,3,15);
  ...
  index(60,100);
  forwardPID(1700,-287,3,30);
  leftPID(187,3,1,90,1,.04,5);
  index(60,100);
  forwardPID(900,-187,3,30);
  index(100,30);
  backwardPID(540,-187,3,30);
  ...
  index(60,100);
  leftPID(391,3,1,90,1,.04,5);
  index(60,100);
  forwardPID(1100,-391,3,30);
  index(60,100);
  backwardPID(770,-391,5,30);
