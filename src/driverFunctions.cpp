...
int chassisMovement(){
  while(true) {
    ...
    if(Controller1.Axis3.value()>0){
      FL.spin(reverse, pow(Controller1.Axis3.value(), 4)/10000, pct);
      BL.spin(reverse, pow(Controller1.Axis3.value(), 4)/10000, pct);
    }
    else{ 
      FL.spin(fwd, pow(Controller1.Axis3.value(), 4)/10000, pct);
      BL.spin(fwd, pow(Controller1.Axis3.value(), 4)/10000, pct);
    }
     
     //driving right side quadtratically 
    if(Controller1.Axis2.value()>0){
      FR.spin(reverse, pow(Controller1.Axis2.value(), 4)/10000, pct);
      BR.spin(reverse, pow(Controller1.Axis2.value(), 4)/10000, pct);
    }
    else{
      FR.spin(fwd, pow(Controller1.Axis2.value(), 4)/10000, pct);
      BR.spin(fwd, pow(Controller1.Axis2.value(), 4)/10000, pct);
    }
...
void autoGroup(){
  ...
  while (true) {
     ...
     optical1Hue = optical1.hue();
      ...
      /*else if(lineSensor3Value <= 66){
        Conveyor1.spin(fwd, 10, pct);
        Conveyor2.spin(fwd, 10, pct);
      }*/
